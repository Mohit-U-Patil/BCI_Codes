function [trainedClassifier, validationAccuracy] = train_svm_grid(trainingData, outlier_fraction, remove_duplicates, optimize_hyperparameters )
...
classificationSVM = fitcsvm(...
    ...
    'HyperparameterOptimizationOptions',struct('Optimizer','gridsearch', 'ShowPlots', false, 'Verbose', 0, 'Repartition', true));
