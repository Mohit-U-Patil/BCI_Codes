function read_data_and_denoise(class2keep,ch2keep,low, high, mother_wavelet, decomposition_level, denoising_method, ThresholdRule, NoiseEstimate)

%file reader
folderpath = '../RCSP_Toolbox_GPL/MI_Data_Cleaned/CNS_MI_Data_Clean/train';
