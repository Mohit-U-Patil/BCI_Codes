function[result,accuracy]   = classify_svm_bayes(trainFeatures, testFeatures) 
...
[svmclassifier, accuracy] = train_svm_bayes(trainFeatures, outlier_fraction, remove_duplicates, optimize_hyperparameters );
