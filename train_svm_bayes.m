function [trainedClassifier, validationAccuracy] = train_svm_bayes(trainingData, outlier_fraction, remove_duplicates, optimize_hyperparameters )
...
% Auto-generated by MATLAB on 25-Jan-2019 13:43:07
...
classificationSVM = fitcsvm(...
    ...
    'OutlierFraction', outlier_fraction, ...
    'Standardize', true, ...
    'OptimizeHyperparameters',optimize_hyperparameters, ...
    'HyperparameterOptimizationOptions',struct('Optimizer','bayesopt','UseParallel', true,'ShowPlots', false, 'Verbose', 0, 'Repartition', true));
    

 % 'OutlierFraction', outlier_fraction, ... 'RemoveDuplicates', remove_duplicates, ...
