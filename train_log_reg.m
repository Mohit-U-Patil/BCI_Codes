function [trainedClassifier, validationAccuracy] = train_log_reg(trainingData)
...
% Auto-generated by MATLAB on 17-Feb-2019 18:39:22
...
cl = unique(inputTable.column_7);
successClass = double(cl(1));
failureClass = double(cl(2));
